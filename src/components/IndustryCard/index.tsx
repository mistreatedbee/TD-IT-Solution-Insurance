...
const accentBarStyles: Record<IndustryCardAccent, string> = {
  // 'blue' now maps to the real brand navy/secondary-blue rather than a
  // generic Tailwind blue-600 unrelated to the logo.
  blue: 'bg-primary',
  green: 'bg-emerald-600',
  amber: 'bg-accent-gold-deep',
  purple: 'bg-violet-600',
  red: 'bg-red-600',
  slate: 'bg-slate-700'
};
const accentIconStyles: Record<IndustryCardAccent, string> = {
  blue: 'bg-secondary-tint text-secondary',
  green: 'bg-emerald-50 text-emerald-600',
  amber: 'bg-accent-gold-tint text-accent-gold-deep',
