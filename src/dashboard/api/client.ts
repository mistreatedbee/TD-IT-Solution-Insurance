...
let clientConfig: DashboardClientConfig | null = null;
let refreshInFlight: Promise<string> | null = null;

export function configureDashboardClient(config: DashboardClientConfig): void {
  clientConfig = config;
}
  ...
  refreshInFlight = (async () => {
    ...
    try {
      const tokens = await rawRequest<{
        ...
        method: 'POST',
        body: { refreshToken, deviceId: null },
        authenticated: false,
      });
