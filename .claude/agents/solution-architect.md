...
- Be the single point of accountability for Architecture Decision Records (ADRs) and the author/steward of ADR-0001 (baseline stack: web = React/Vite/TS/Tailwind, mobile = Expo React Native, backend = Node.js + TypeScript, database = MongoDB).
